/*
  ...
  - The primary key for the `AiSearchQuota` table will be changed. If it partially fails, the table could be left without primary key constraint.
  ...
  - The primary key for the `ServicePlan` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
*/
-- DropForeignKey
ALTER TABLE "ServiceItem" DROP CONSTRAINT "ServiceItem_servicePlanId_fkey";

-- DropForeignKey
ALTER TABLE "ServiceItem" DROP CONSTRAINT "ServiceItem_songId_fkey";

-- AlterTable
ALTER TABLE "AiSearchQuota" DROP CONSTRAINT "AiSearchQuota_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ADD CONSTRAINT "AiSearchQuota_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "AiSearchQuota_id_seq";

-- AlterTable
ALTER TABLE "MediaFile" DROP CONSTRAINT "MediaFile_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ADD CONSTRAINT "MediaFile_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "MediaFile_id_seq";
...
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "servicePlanId" SET DATA TYPE TEXT,
ALTER COLUMN "songId" SET DATA TYPE TEXT,
ADD CONSTRAINT "ServiceItem_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "ServiceItem_id_seq";

-- AlterTable
ALTER TABLE "ServicePlan" DROP CONSTRAINT "ServicePlan_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ADD CONSTRAINT "ServicePlan_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "ServicePlan_id_seq";
