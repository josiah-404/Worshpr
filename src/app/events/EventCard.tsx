...
export const EventCard: FC<EventCardProps> = ({ event, onDelete }) => {
  ...
  return (
    <>
      <Card
        className="overflow-hidden flex flex-col group border-border/60 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
            ...
            <div className="flex items-center gap-1.5 mt-1.5">
              ...
              <span className="text-[11px] text-white/75 truncate">
                ...
                {collaborators.length > 0 && (
                  <span className="text-white/50 ml-1">+{collaborators.length} more</span>
                )}
              </span>
            </div>
          </div>
